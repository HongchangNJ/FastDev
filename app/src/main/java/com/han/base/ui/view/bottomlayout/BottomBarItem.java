package com.han.base.ui.view.bottomlayout;
 ...
 * @description: 底部tab条目
 * @date 2017/6/23  9:14
 * @github https://github.com/chaychan/BottomBarLayout
 *
 * 根据需求修改了部分代码
 */
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        mTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemTextSize, SizeUtils.sp2px(mContext, mTextSize));
        ...
        mMarginTop = ta.getDimensionPixelSize(R.styleable.BottomBarItem_itemMarginTop, SizeUtils.dp2px(mContext, mMarginTop));
        ...
        mUnreadTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_unreadTextSize, SizeUtils.sp2px(mContext, mUnreadTextSize));
        ...
        mMsgTextSize = ta.getDimensionPixelSize(R.styleable.BottomBarItem_msgTextSize, SizeUtils.sp2px(mContext, mMsgTextSize));
