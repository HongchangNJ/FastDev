...
public class ApiRetrofit {
    ...
    private Interceptor mHeaderInterceptor = chain -> {
        ...
        //builder.addHeader("device_id", ConfigUtils.getDeviceId()); // 设备id
        //builder.addHeader("time", (System.currentTimeMillis() / 1000) + ""); // 系统时间
        //if (AccountManager.getLoginBean() != null) {
        //    builder.addHeader("token", AccountManager.getLoginBean().token);
        //}
        // @Headers({"os:android"})
    ...
    public ApiRetrofit() {
        //cache url
        File httpCacheDirectory = new File(BaseApplication.instance.getCacheDir(), "responses");
