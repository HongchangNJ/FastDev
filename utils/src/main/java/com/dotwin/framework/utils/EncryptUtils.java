...
import static com.dotwin.framework.utils.ConvertUtils.bytes2HexString;
import static com.dotwin.framework.utils.ConvertUtils.hexString2Bytes;
...
public class EncryptUtils {
     ...
     * @return byte[]
     */
    public static byte[] encryptToken(byte[] datasource, String password) {
        try {
            SecureRandom random = new SecureRandom();
