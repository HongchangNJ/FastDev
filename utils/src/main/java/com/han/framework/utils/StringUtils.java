...
public class StringUtils {
     ...
     * @return
     */
    public static int parseStrToInt(String numStr) {
     ...
     * @return
     */
    public static long parseStrToLong(String numStr) {
        if (TextUtils.isEmpty(numStr)) {
            return 0;
        }
     ...
     * @return
     */
    public static double parseStrToDouble(String numStr) {
        if (TextUtils.isEmpty(numStr)) {
            return 0;
        }
     ...
     * @return
     */
    public static float parseStrToFloat(String numStr) {
        if (TextUtils.isEmpty(numStr)) {
            return 0;
        }
